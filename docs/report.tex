...
\begin{figure}[H]
    ...
    \caption{\textbf{✦ AI Auto-Confirm (Mailbox Agent)} button (purple) in the Buyer panel. The server uses GPT-4o-mini to decide whether sensor readings confirm package presence before submitting the on-chain transaction.}
    \label{fig:aimailbox}
\end{figure}
